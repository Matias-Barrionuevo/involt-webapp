...
import GeneratedInvoices from '@/modules/Invoices/components/table/GeneratedInvoices';
import { Plus } from 'lucide-react';

const InvoicesGeneratedPage = () => {
  return (
    <section className="h-full w-full px-8 py-4 mt-4 shadow-lg border rounded-3xl">
      <main>
